...
if input_user == '1': #OPSI 1
 ...
 __     ________ 
|  | __/   __   \         {Wh}----------------------------------      
|  |/ /\____    /         {Wh}|  {Gr}K9 - SHOW YOUR IP ADDRESS  {Wh}|
|    <    /    /          {Wh}|        {Gr}@CODE BY K9       {Wh}|
|__|_ \  /____/           {Wh}----------------------------------
     \/          
 ...
 __     ________ 
|  | __/   __   \         {Wh}----------------------------------      
|  |/ /\____    /         {Wh}|  {Gr}K9 - SHOW INFORMATION PHONE NUMBERS  {Wh}|
|    <    /    /          {Wh}|        {Gr}@CODE BY K9       {Wh}|
|__|_ \  /____/           {Wh}----------------------------------
     \/          
    ...
    try:
        def phoneGW():
            User_phone = input(f"\n {Wh}Enter phone number target {Gr}Ex [+251xxxxxxxxx] {Wh}: {Gr}") #INPUT NUMBER PHONE
            default_region = "ID" #DEFAULT Addis ababa Ethiopia
...
|__|_ \  /____/           {Wh}----------------------------------
 ...
 __     ________ 
|  | __/   __   \         {Wh}----------------------------------      
|  |/ /\____    /         {Wh}|  {Gr}K9 - SHOW INFORMATION USERNAME  {Wh}|
|    <    /    /          {Wh}|        {Gr}@CODE BY K9       {Wh}|
|__|_ \  /____/           {Wh}----------------------------------
     \/          
    ...
    try:
        def TrackLu(username):
            ...
            {"url": "https://www.threads.com/{}", "name": "threads"}
            ]
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING {Gr}K9-TRACK !")
else:
